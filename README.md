...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/triad-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13800&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/triad-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `triad` can be installed with:

```
conda install triad
```

It is possible to list all of the versions of `triad` available on your platform with:
